                ...
                <div class="col-span-12 lg:col-span-6 mt-8">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        <div class="mb-3 ml-3">
                            <div class="flex">
                                <div>
                                    <div class="text-primary dark:text-slate-300 text-lg xl:text-xl font-medium">{{number_format($revenue)}} VND
                                    </div>
                                ...
                                <div>
                                    <div class="text-slate-500 text-lg xl:text-xl font-medium">{{ number_format($lastMonthrevenue) }} VND</div>
