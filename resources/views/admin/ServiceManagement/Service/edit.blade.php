            ...
            <form id="ajaxForm" enctype="multipart/form-data">
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-2">
                            <select name="category_services_id" id="category_services_id" data-placeholder="Select your favorite actors" class="tom-select w-full">
                    ...
                    <div class="mt-3">
                        ...
                        value="{{$one_service->percentage_discount}}"   placeholder="Percentage_discount">
                    </div>
