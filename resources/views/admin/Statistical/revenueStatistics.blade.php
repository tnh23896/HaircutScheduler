                ...
                <div class="mt-4 text-right">
                    ...
                    @csrf
										@foreach ($totalRevenue as $key => $item)
												<input type="hidden" name="totalRevenue[{{ $key}}]['month']" value="{{ $item['month'] }}">
												<input type="hidden" name="totalRevenue[{{ $key}}]['totalRevenues']" value="{{ $item['totalRevenues'] }}">
												<input type="hidden" name="totalRevenue[{{ $key}}]['ca1']" value="{{ $item['ca1'] }}">
												<input type="hidden" name="totalRevenue[{{ $key}}]['ca2']" value="{{ $item['ca2'] }}">
												<input type="hidden" name="totalRevenue[{{ $key}}]['ca3']" value="{{ $item['ca3'] }}">
										@endforeach
