                    ...
                    <div class="intro-y h-10 mb-5 flex flex-col lg:flex-row justify-between items-center" style="display: flex;justify-content: space-between">
                        ...
                        <form id="searchTime" method="POST">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="date" style="border-color: #312E81" name="start_date" id="start_date" class="mx-3 py-2 px-4 border rounded" placeholder="Ngày bắt đầu" onchange="validateDate()">
                            
                                <label for="end_date" class="mr-2">Ngày kết thúc:</label>
                                <input type="date" style="border-color: #312E81" name="end_date" id="end_date" class="mx-3 py-2 px-4 border rounded" placeholder="Ngày kết thúc" onchange="validateDate()">
                            
                                <button type="button" id="saveSearchTime" style="border-color: #312E81" class="btn btn-secondary mr-1 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="filter" data-lucide="filter" class="lucide lucide-filter block mx-auto">
