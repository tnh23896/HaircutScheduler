                ...
                <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                    <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                        <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                            <img alt="Midone - HTML Admin Template" class="rounded-full" src="{{$item->user->avatar === 'default.jpg' ? asset('dist/images/default.jpg') : asset($item->user->avatar) }}">
                        </div>
                        <div class="ml-5">
                    ...
                    <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                        <div class="font-medium text-center lg:text-left lg:mt-3">Nhân viên: {{ $item->admin->username }}</div>
                        <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                            <div class="truncate sm:whitespace-normal flex items-center"> <i data-lucide="dollar-sign" class="w-4 h-4 mr-2"></i> @if ($item->payment == 'vnpay' || $item->payment == 'momo')
                            ...
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-lucide="dollar-sign" class="w-4 h-4 mr-2"></i>                 <h4 class="font-bold text-2sm">
                            ...
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-lucide="dollar-sign" class="w-4 h-4 mr-2"></i>                 @if ($item->payment == 'vnpay' || $item->payment == 'momo')
