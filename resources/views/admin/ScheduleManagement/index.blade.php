                            ...
                            <td class="text-center">
                                <form id="ajaxForm" enctype="multipart/form-data">
                                    ...
                                    <input id="price" type="text" class="form-control w-full"
                                        placeholder="Input text" value="{{ $item->total_price }}" name="price" disabled
                                        hidden>
                                    ...
                                    <select class="statusSelect form-select w-full" data-id="{{ $item->id }}"
                                        ...
                                        @if ($item->status == 'pending')
                                            <option value="pending" {{ $item->status == 'pending' ? 'selected' : '' }}>Chưa
                                                xác
                                                nhận</option>
                                        ...
                                        @elseif ($item->status == 'waiting')
                                            <option value="waiting" {{ $item->status == 'waiting' ? 'selected' : '' }}>Đang
                                                chờ
                                                cắt</option>
                                        ...
                                        @elseif ($item->status == 'canceled')
                                            <option value="canceled" {{ $item->status == 'canceled' ? 'selected' : '' }}>Đã
                                                hủy
                                            </option>
                                        @endif
                                    </select>
