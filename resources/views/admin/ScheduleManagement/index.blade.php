        ...
        <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tr class="intro-x">
                    ...
                    <td class="text-center"> <a class="flex items-center justify-center underline decoration-dotted" href="javascript:;">{{$item->admin->username}}</a> </td>
                    <td class="text-center capitalize">{{number_format($item->price) }}</td>
                    <td class="w-40">
                        <div class="flex items-center justify-center">{{$item->work_schedule_detail->time->time }} <br> {{$item->day}}</div>
                    </td>
