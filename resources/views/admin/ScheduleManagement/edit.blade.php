        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="intro-y box p-5">
                ...
                <div class="text-right mt-5">
                    <a href="{{route('admin.scheduleManagement.index')}}" class="btn btn-outline-secondary w-32 mr-1">Quay Lại</a>
                    @if($data->status !== "success")
                    <button type="button" id="saveBtn" class="btn btn-primary w-32 text-white">Lưu thay đổi</button>
                    @endif
                </div>
            </div>
            <!-- END: Form Layout -->
