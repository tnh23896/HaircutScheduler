    ...
    <form action="{{ route('admin.auth.login') }}" method="post">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div
                ...
                <div class="intro-x mt-10 xl:mt-24 text-slate-600 dark:text-slate-500 text-center xl:text-left"> By signin
                    up, you agree to our <a class="text-primary dark:text-slate-200" href="#">Terms and Conditions</a>
