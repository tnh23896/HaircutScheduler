...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            @if(auth('admin')->user()->can('admin.blogManagement.blog.create'))
        ...
        @foreach ($blogs as $blog)
            <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                    ...
                    <div class="dropdown ml-3">
                        ...
                        <div class="dropdown-menu w-40">
                            <ul class="dropdown-content">
                                @if(auth('admin')->user()->can('admin.blogManagement.blog.edit'))
                                    <li>
                                ...
                                @endif
                                @if(auth('admin')->user()->can('admin.blogManagement.blog.delete'))
                                    <li>
                                        <form class="delete-form p-2"
                                              action="{{ route('admin.blogManagement.blog.delete', $blog->id) }}"
                                              method="POST">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="p-5">
                    ...
                    <div
                        class="text-slate-600 dark:text-slate-500 mt-2 overflow-hidden overflow-ellipsis cursor-pointer">
