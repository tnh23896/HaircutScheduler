                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-center text-150">
                                        <img src="{{ asset('client/assets/images/writelogo.png')}}" alt="" width="125px">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="text-grey-m2">
                                        ...
                                        <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">{{$bill->phone}}</b></div>
                                    </div>
                                </div>
                                <!-- /.col -->
                                ...
                                <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                    ...
                                    <div class="text-grey-m2">
                                        ...
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Issue Date:</span> {{$bill->created_at}}</div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                        ...
                                        <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                            ...
                                            <div class="col-5">
                                                <span class="text-150 text-success-d3 opacity-2">{{$bill->total_price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
