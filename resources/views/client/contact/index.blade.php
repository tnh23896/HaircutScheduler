                            ...
                            <form id="contactForm" action="{{ route('contact.sendEmail') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="email">Email: <span
                                            style="color: red; width: 2px !important;">*</span></label>
                                ...
                                <button type="button" id="sendEmailBtn" class="btn btn-primary border-0"
                                    style="background-color: #d9842f; width:100px;">Gửi</button>
                            </form>
