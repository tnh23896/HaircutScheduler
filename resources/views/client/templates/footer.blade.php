                    ...
                    <div class="widget">
                        ...
                        <div>
                            ...
                            <ul class="text-white wiget-link wiget-hover">
                                ...
                                <li><a href="{{ route('client.aboutus') }}"><span><i
                                                class="fas fa-angle-right"></i></span>Giới
                                        thiệu</a></li>
                                <li><a href="{{ route('client.policy') }}"><span><i
                                                class="fas fa-angle-right"></i></span>Chính
                                        sách</a></li>
                                <li><a href="javascript:void(0)"><span><i class="fas fa-angle-right"></i></span>Chi
                                        tiết</a></li>
                                <li><a href="{{ route('client.contact') }}"><span><i
                                                class="fas fa-angle-right"></i></span>Liên hệ</a></li>
                            </ul>
