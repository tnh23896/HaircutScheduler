...
<link rel="stylesheet" type="text/css" href="{{ asset('client/assets/css/jquery.fancybox.min.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('client/assets/css/aos.css') }}">
