    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="price-content">
                    ...
                    <div class="price-inner d-flex justify-content-between align-items-baseline">
                        ...
                        <hr class="w-100 m-0">
                        <p class="pl-3" style="white-space: nowrap;">{{number_format($service->price ?? '')}} VND</p>
                    </div>
                    @endforeach
                </div>
            </div>
            <div class="col-lg-5 col-md-12 offset-lg-1">
                <div class="my-5">
                    <img class="img-fluid mx-auto my-auto" src="{{asset($category['image'] ?? '')}}" alt="{{$category['category'] ?? ''}}" style="max-width: 100%; max-height: 100%;">
                </div>
            </div>   
            @else
            <div class="col-lg-5 col-md-12 offset-lg-1">
